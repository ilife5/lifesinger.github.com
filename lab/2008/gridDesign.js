...
var GridDesign = {
	...
	paint: function() {
		...
		var N = this.data.N.value * 1,
		c = this.data.c.value * 1,
		g = this.data.g.value * 1,
		m1 = this.data.m1.value * 1,
		m2 = this.data.m2.value * 1,
		W = this.data.W.value * 1;
		...
		var loader = new YAHOO.util.YUILoader({
			...
			onSuccess: function() {
				var rs = new YAHOO.util.Resize(container);
			}
		});
		loader.insert();
	},
	...
	paintRows: function() {
		...
		// create it
		var c = this.data.c.value * 1.0,
		g = this.data.g.value * 1.0,
		m1 = this.data.m1.value * 1.0,
		m2 = this.data.m2.value * 1.0,
		W = this.data.W.value * 1.0;
