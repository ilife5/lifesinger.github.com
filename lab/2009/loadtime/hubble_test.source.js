...
(function() {
    ...
    var API_URL = "http://igw.monitor.taobao.com/monitor-gw/receive.do",
        ...
        SAMPLE_RATE = 0, // 抽样：万分之一
        ua = navigator.userAgent,
        startTime = HUBBLE_st, // 读取页头处的布点时间
        endTime = HUBBLE_et || HUBBLE_dr, // 读取页尾处的布点时间 注：HUBBLE_dr 是兼容以前的布点
    ...
    var sendData = function() {
        ...
        try {
            new Image().src = [
                ...
                //"&url=", encodeURIComponent(location.href) 由后台获取
            ].join("");
        } catch(ex) {}
    };
